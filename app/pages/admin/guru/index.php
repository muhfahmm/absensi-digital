                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-5 py-4 border-b border-gray-100 bg-white text-sm text-center">
                                    <div class="flex justify-center space-x-2">
                                        <?php if($view == 'mapel'): ?>
                                            <button onclick="requestAction('edit_mapel.php?id=<?= $row['id'] ?>', 'edit')" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg text-xs font-bold transition hover:bg-indigo-100">Edit</button>
                                            <button onclick="requestAction('delete_mapel.php?id=<?= $row['id'] ?>', 'delete')" class="text-red-600 hover:text-red-900 bg-red-50 px-3 py-1.5 rounded-lg text-xs font-bold transition hover:bg-red-100">Hapus</button>
                                        <?php else: ?>
...
<script>
    ...
    function requestAction(url, actionType) { // Keep signature for compatibility
        targetUrl = url;
