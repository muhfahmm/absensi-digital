...
<aside class="w-64 bg-white border-r border-gray-200 min-h-screen hidden md:block">
    ...
    <nav class="mt-4">
        <ul class="space-y-2">
            ...
            <!-- Rekap Absensi -->
             <li>
                <a href="<?= base_url('app/pages/admin/rekap-absensi/index.php') ?>" class="flex items-center px-6 py-3 transition rounded-r-full mr-2 <?= is_active('/admin/rekap-absensi/') ?>">
