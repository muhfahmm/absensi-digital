    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <a href="data_tagihan.php" class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition flex items-center justify-center text-blue-600 font-semibold border border-blue-100">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Data Tagihan
                </a>
                <a href="buat_tagihan.php" class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition flex items-center justify-center text-green-600 font-semibold border border-green-100">
