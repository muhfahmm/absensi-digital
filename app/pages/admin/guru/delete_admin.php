<?php
// app/pages/admin/guru/delete_admin.php
session_start();
...
if ($id) {
    ...
    try {
        ...
        echo "<script>alert('Data Admin Berhasil Dihapus!'); window.location.href='index.php?view=admin';</script>";
    } catch (PDOException $e) {
        $msg = "Gagal menghapus: " . $e->getMessage();
        echo "<script>alert('$msg'); window.location.href='index.php?view=admin';</script>";
    }
} else {
    redirect('app/pages/admin/guru/index.php?view=admin');
}
